    ...
    <div class="container">
        ...
        <div class="offset-md-3 col-md-6">
          ...
          <span v-if="allErrors.currentPassword">
            <span
              ...
              v-for="error in allErrors.currentPassword"
              :key="error"
            >
              - {{ error }}
            </span>
      ...
      <div class="row">
        <div class="offset-md-3 col-md-6">
          ...
          <span v-if="allErrors.newPassword">
            <span
              class="text-danger small"
              v-for="error in allErrors.newPassword"
              :key="error"
            >
              - {{ error }}
            </span>
      ...
      <div class="row">
        <div class="offset-md-3 col-md-6">
          ...
          <input
            class="form-control"
            v-model="data.newPassword_confirmation"
            id="confirmPassword"
            type="password"
      ...
      <div class="text-center m-3">
        <button class="btn-lg btn-primary" @click="editPassword">
          Edit Password
        </button>
      </div>
    </div>
