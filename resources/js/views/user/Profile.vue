<template>
  ...
  <div class="card mb-4">
    <div class="card-header">
      <span class="text-center h2 wow fadeInLeft" data-wow-delay="0.1s"
      ...
      <span class="float-end">
        <div class="cls-toggle-container wow fadeInLeft" data-wow-delay="0.2s">
          <input
            ...
            class="cls-toggle"
          />
          <label for="fast" class="cls-label">
            <div class="cls-ball"></div>
          </label>
          <span>Edit</span>
        </div>
      </span>
    ...
    <div class="card-body container">
      ...
      <div>
        ...
        <div class="row gx-3 mb-3 wow fadeInLeft" data-wow-delay="0.3s">
          ...
          <div class="col-md-6">
            <label
              class="small mb-1 wow fadeInLeft"
              data-wow-delay="0.4s"
              for="first_name"
              >First name</label
            >
        ...
        <!-- Save changes button-->
        <button
          class="btn btn-primary wow fadeInLeft"
          data-wow-delay="0.9s"
          @click="editUser"
          v-if="canEdit"
        >
