    ...
    <div class="overflow-auto cls-height">
      ...
      <div class="cls-table-carts wow fadeInLeft" data-wow-delay="0.5s">
        <div
          ...
          v-for="favorite in getAllFavorites"
          :key="favorite.id"
        >
          <img
            :src="favorite.p_image"
            alt=""
            class="col-sm-12 col-md-2 col-lg-2 img-fluid cls-img-cart"
          />
          <div class="col-sm-6 col-md-7 col-lg-7">
            <router-link
              :to="`/shope/${favorite.product_id}`"
              class="h4 text-decoration-none"
              >{{ favorite.p_name }}</router-link
            >
          ...
          <div class="col-sm-6 col-md-3 col-lg-3 cls-left-cart align-items-end">
            <button
              ...
              class="btn-lg btn-outline-danger m-md-2 cls-btn-custom"
            >
