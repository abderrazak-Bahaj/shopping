      ...
      <div class="row">
        ...
        <div class="col-md-6 wow fadeInLeft" data-wow-delay="1s">
          <div class="col-md-9 col-lg-8 mx-auto">
            ...
            <div class="d-grid">
              <button
                class="btn-lg btn-outline-primary cls-btn-login m-2"
                @click="register"
              >
                Register
              </button>
              <div class="text-center">
                ...
                <router-link to="/login" class="small">click her</router-link>
              </div>
            </div>
          </div>
        </div>
    ...
    register: async function () {
      ...
      if (await this.validation()) {
        await this.$store
          ...
          .then((response) => {
            this.$router.push(`email/resend/${response.access_Token}`);
          })
          .catch(() => {})
          .finally(() => {
            this.isBusy = false;
