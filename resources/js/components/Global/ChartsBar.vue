  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card mb-4">
        ...
        <div class="card-body">
          <canvas ref="myBarChartOrder" width="100%" height="50"></canvas>
        </div>
    ...
    <div class="col-md-6">
      <div class="card mb-4">
        ...
        <div class="card-body">
          <canvas ref="myPieChartOrder" width="100%" height="50"></canvas>
        </div>
        <div class="card-footer small text-muted">
          Updated at {{ new Date().toLocaleString() }}
        </div>
    ...
    <div class="col-md-6">
      <div class="card mb-4">
        ...
        <div class="card-body">
          <canvas ref="myPieChartUser" width="100%" height="50"></canvas>
        </div>
        <div class="card-footer small text-muted">
          Updated at {{ new Date().toLocaleString() }}
        </div>
